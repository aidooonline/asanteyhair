...
$all_faqs = [
  ...
  'Ordering & Shipping' => [
    ['How do I place an order?',
     'You can order directly through our website using our secure checkout system. Simply add your desired products to your bag and follow the checkout process. We accept all major payment methods.'],
    ['How long does delivery take?',
     'We dispatch orders within 2–3 business days. Standard UK delivery then takes 1–3 business days. Express delivery options are available on request — contact us if you need your order urgently.'],
    ['Do you ship internationally?',
     'We currently ship primarily within the UK. For international orders, please contact us before placing an order so we can confirm shipping costs to your location.'],
    ['What payment methods do you accept?',
     'We accept all major debit/credit cards through our secure checkout. Payment details are provided at the final stage of your order.'],
    ['Can I track my order?',
     'Yes. Once your order is dispatched, you will receive a tracking number via email. You can use this to track your delivery in real time.'],
  ],
  'HD Lace & Closures' => [
    ['What is HD lace?',
