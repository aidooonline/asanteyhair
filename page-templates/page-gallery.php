...
<section class="section">
  <div class="wrap">
    ...
    <div class="gallery gallery--masonry ah-reveal">
      <?php for($i=1;$i<=7;$i++): ?>
    ...
    <div style="text-align:center;margin-top:var(--ah-space-16);" class="reveal">
      <p class="t-body--lg" style="margin-bottom:var(--ah-space-6);">Tag us on Instagram to be featured in our gallery.</p>
...
<div class="cta-band"><div class="wrap"><div class="reveal">
  ...
  <div class="btn-group" style="justify-content:center;">
    <a href="<?php echo esc_url(home_url('/shop/')); ?>" class="btn btn--black">Shop Collections <?php echo ah_svg('arrow-right'); ?></a>
